    ...
    function submit_button( $form_id, $form_settings, $post_id ) {
        ...
        <li class="wpuf-submit">
            ...
            if ( $post_id ) {
                ...
                <button class="g-recaptcha" data-sitekey="6LcO2CIUAAAAAAq97s9xdpjD1tvqPPPKxnZwwhZ-" data-callback="YourOnSubmitFn"><?php echo $form_settings['submit_text']; ?><?php echo $form_settings['update_text']; ?></button>

            <?php } else { ?>
                <button class="g-recaptcha" data-sitekey="6LcO2CIUAAAAAAq97s9xdpjD1tvqPPPKxnZwwhZ-" data-callback="YourOnSubmitFn"><?php echo $form_settings['submit_text']; ?></button>
